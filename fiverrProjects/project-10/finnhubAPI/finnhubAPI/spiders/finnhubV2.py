...
class Finnhubv2Spider(scrapy.Spider):
        ...
        for file in files:
            ...
            for symb in symbol_list:
                ...
                yield scrapy.Request(
                    url=f"https://finnhub.io/api/v1/company-news?symbol={symb}&from={self.SEVEN_DAYS_BACK}&to={self.TODAY}&token={self.API_TOKEN}",
    ...
    def companyNews(self, response):
        ...
        yield scrapy.Request(
            url=f"https://finnhub.io/api/v1/news-sentiment?symbol={dataDict['Symbol']}&from={self.SEVEN_DAYS_BACK}&to={self.TODAY}&token={self.API_TOKEN}",
    ...
    def newsSentiment(self, response):
        ...
        yield scrapy.Request(
            url=f"https://finnhub.io/api/v1/stock/recommendation?symbol={dataDict['Symbol']}&from={self.SEVEN_DAYS_BACK}&to={self.TODAY}&token={self.API_TOKEN}",
    ...
    def recommendationTrends(self, response):
        ...
        yield scrapy.Request(
            url=f"https://finnhub.io/api/v1/stock/metric?symbol={dataDict['Symbol']}&metric=all&from={self.SEVEN_DAYS_BACK}&to={self.TODAY}&token={self.API_TOKEN}",
    ...
    def companyBasicFinancials(self, response):
        ...
        yield scrapy.Request(
            url=f'''https://finnhub.io/api/v1/scan/technical-indicator?symbol={dataDict['Symbol']}&resolution=D&token={self.API_TOKEN}''',
    ...
    def aggregateIndicator_day(self, response):
        ...
        yield scrapy.Request(
            url=f'''https://finnhub.io/api/v1/scan/technical-indicator?symbol={dataDict['Symbol']}&resolution=W&token={self.API_TOKEN}''',
    ...
    def aggregateIndicator_week(self, response):
        ...
        yield scrapy.Request(
            url=f'''https://finnhub.io/api/v1/scan/technical-indicator?symbol={dataDict['Symbol']}&resolution=M&token={self.API_TOKEN}''',
