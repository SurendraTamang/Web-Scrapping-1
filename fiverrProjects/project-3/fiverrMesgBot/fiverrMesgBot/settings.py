# Scrapy settings for fiverrMesgBot project

BOT_NAME = 'Googlebot'

SPIDER_MODULES = ['fiverrMesgBot.spiders']
NEWSPIDER_MODULE = 'fiverrMesgBot.spiders'
...
SELENIUM_DRIVER_EXECUTABLE_PATH = "Give your chrome driver path"
