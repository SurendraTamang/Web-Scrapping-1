...
class LinkedinBot:
    ...
    def post(self, text):
        """ Make a text post """
        self.driver.find_element_by_xpath("(//button[contains(@class, 'share-box')])[1]").click()
        self.driver.find_element_by_xpath("(//div[contains(@class, 'ql-editor')])[1]").send_keys(text)
        time.sleep(2)
        self.driver.find_element_by_xpath("//span[text()='Post']/parent::button").click()
        time.sleep(3)
